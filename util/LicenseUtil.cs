...
namespace Invoice365.util
{
	class LicenseUtil
	{
        public static string licenseCheck(string path)
        {
            ...
            {                
                RegistryKey _key = Registry.CurrentUser.OpenSubKey("SOFTWARE\\EWebComputing\\Invoice365");
                if (_key == null)
                {
                    createTrialLicense(path);
                    RegistryKey key = Registry.CurrentUser.CreateSubKey("SOFTWARE\\EWebComputing\\Invoice365");                    
                }
                else
                {
                    return null;
        ...
        private static XmlDocument ProduceSingleLicense(string computerId)
        {
            ...
            XmlElement elem = doc.CreateElement("Invoice365");
            ...
            ArrayList ar = new ArrayList();
                ...
                featureInfo.featureName = "Invoice365";
